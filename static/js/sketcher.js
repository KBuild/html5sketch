function Sketcher( canvasID, brushImage, pathCount ) {
...
Sketcher.prototype.reDraw = function(data) {
    this.context.drawImage(this.brush, data.x, data.y);
}
